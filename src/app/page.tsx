...
export default function WeatherHomepage() {
  ...
  return (
    <div className={`flex flex-col min-h-screen bg-gradient-to-b from-blue-100 to-blue-200 transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <footer className={`bg-blue-800 text-white py-8 transition-all duration-1000 delay-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">About WeatherApp</h3>
              <p className="text-sm">Providing accurate weather forecasts and information to help you plan your day.</p>
            </div>
            <div>
          ...
          <div className="mt-8 border-t border-blue-700 pt-8 text-center">
            <p className="text-sm">&copy; {new Date().getFullYear()} WeatherApp. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
